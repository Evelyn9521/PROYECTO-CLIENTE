        ...
        <div className=" content imgBackground">
            ...
            <div className="InicioTwoColumns">
                ...
                <ul className="columnleftt">
                    ...
                    <li><a href="#titulo10">Video explicativo</a></li>
                </ul>
                ...
                <div className="columnrigth">
                    ...
                    <div className="witdhDiv styleParagraph marginBottom">
                        ...
                        <ul>
                            ...
                            <li>Historia personal de cáncer de mama invasivo (las mujeres que han tenido un cáncer de mama invasivo tienen más riesgo de padecer un cáncer de mama contralateral), carcinoma ductal in situ o carcinoma lobulillar in situ.</li>
                            <li>Historia personal de enfermedad proliferativa benigna de la mama.</li>
                            <li>Historia familiar de cáncer de mama en un familiar de primer grado (madre, hija, hermana).</li>
                            <li>Portadoras de mutaciones en los genes BRCA 1 y 2 o en otros genes que aumentan el riesgo de padecer un cáncer de mama.</li>
                            <li>Densidad mamaria elevada en las mamografías.</li>
                            <li>Factores reproductivos que aumentan la exposición a los estrógenos endógenos, como la aparición temprana de la primera regla , la menopausia tardía o la nuliparidad (no haber estado embarazada nunca)</li>
                            <li>El consumo de alcohol. Algunos estudios muestran que el riesgo de la mujer de tener cáncer de mama aumenta cuanto mayor sea la cantidad de alcohol que tome.</li>
                            <li>La obesidad.</li>
                            <li>No mantenerse físicamente activa. Las mujeres que no se mantienen físicamente activas tienen un mayor riesgo de tener cáncer de mama.</li>
                            <li>No mantenerse físicamente activa. </li>
                        </ul>
                    </div>
                    ...
                    <div className="witdhDiv marginBottom">
                        ...
                        <ul>
                            ...
                            <li>No tome alcohol con regularidad</li>
                            <li>Si está recibiendo, o le han dicho que reciba, terapia de reemplazo hormonal o anticonceptivos orales, consulte a su médico y averigue si es lo mejor para usted</li>
                            <li>Si es posible, amamante a sus hijos.</li>
                            <li>Si tiene antecedentes familiares de cáncer de mama o cambios heredados en sus genes BRCA1 y BRCA2, hable con su médico acerca de otras maneras de reducir su riesgo.</li>
                        </ul>
                    </div>
                    ...
                    <div className="witdhDiv styleParagraph marginBottom">
                        ...
                        <ul>
                            ...
                            <li>Imagen por resonancia magnética. En la resonancia magnética de las mamas se utilizan imanes y ondas de radio para tomar fotografías de las mamas. La resonancia magnética se utiliza junto con las mamografías para examinar a las mujeres que tienen un riesgo alto de presentar cáncer de mama. No se usa en las mujeres que tienen un riesgo promedio porque la resonancia magnética de las mamas puede tener un resultado anormal aun cuando no haya cáncer.</li>
                        </ul>
                    </div>

                    <div className="witdhDiv">
                        <p>Otras pruebas de detección pueden ser:</p>
                        <ul>
                            <li>Un examen clínico de las mamas. Es un examen hecho por un médico o una enfermera que usa sus manos para detectar bultos u otros cambios.</li>
                            <li>Estar familiarizada con cómo se ven sus mamas y cómo se sienten al tacto puede ayudarla a notar síntomas como bultos, dolores o cambios en el tamaño que puedan causar preocupación. Esto puede incluir cambios detectados durante un autoexamen de las mamas. Le debe informar todos los cambios que note a su médico o proveedor de atención médica.</li>
                        </ul>
                    </div>
                    ...
                    <div className="witdhDiv marginBottom">
                        ...
                        <ul>
                            ...
                            <li>Imagen por resonancia magnética de las mamas. Un tipo de examen del cuerpo que usa un imán conectado a una computadora. La resonancia magnética hará imágenes detalladas de áreas dentro de la mama.</li>
                            <li>Biopsia. Esta es una prueba en la que se extirpa tejido o se saca líquido de la mama para estudiarse bajo el microscopio o para hacer más pruebas. Existen distintos tipos de biopsias (por ejemplo, aspiración con aguja fina, biopsia con aguja gruesa o biopsia abierta).</li>
                        </ul>
                    </div>
                    ...
                    <div className="witdhDiv styleParagraph marginBottom">
                        ...
                        <ul>
                            ...
                            <li>Quimioterapia: Se usan medicamentos especiales para reducir o matar las células cancerosas. Estos medicamentos pueden ser pastillas que se toman o medicamentos que se inyectan en las venas, o a veces ambos.</li>
                            <li>Terapia hormonal: Impide que las células cancerosas obtengan las hormonas que necesitan para crecer.</li>
                            <li>Terapia biológica: Trabaja con el sistema inmunitario de su cuerpo para ayudarlo a combatir las células cancerosas o a controlar los efectos secundarios que causan otros tratamientos contra el cáncer. Los efectos secundarios son la manera en que su cuerpo reacciona a los medicamentos u otros tratamientos.</li>
                            <li>Radioterapia: Se usan rayos de alta energía (similares a los rayos X) para matar las células cancerosas.</li>
                        </ul>
                    </div>
